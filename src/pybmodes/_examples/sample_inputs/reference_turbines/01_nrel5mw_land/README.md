...
tower = Tower("sample_inputs/reference_turbines/01_nrel5mw_land/01_nrel5mw_land_tower.bmi")
tower_modal = tower.run(n_modes=8)
print("tower freqs (Hz):", tower_modal.frequencies[:4])

blade = RotatingBlade("sample_inputs/reference_turbines/01_nrel5mw_land/01_nrel5mw_land_blade.bmi")
